...
void main() {
  test('ByteDataWrapper', () {
    ...
    expect(hex.encoder.convert(Uint8List.sublistView(map[bw1].value)), equals('62706c6973'));

    map[bw3] = bw3;
    expect(map.length, equals(2));
    expect(hex.encoder.convert(Uint8List.sublistView(map[bw3].value)), equals('62757cd3fa'));
  });
  ...
  group('dict', () {
    ...
    test('filledDict', () {
      ...
      expect(g.lengthInBytes, 291); // the length will be identical to the xcodeTemplate above.
      ...
      expect(dict['date'], equals(DateTime.utc(1890, DateTime.june, 25, 06, 45, 13)));
